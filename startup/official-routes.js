...
const userApprovedExtraWorks = require("./../routers/official/timex/user-approved-extra-works");
//---
...
const userMyCardsReport = require("./../routers/official/timex/reports/user-my-cards-report");
//---
...
module.exports = function (app) {
  ...
  app.use(
    "/api/official/timex/user-approved-extra-works",
    userApprovedExtraWorks
  );
  //---
  ...
  app.use("/api/official/timex/user-my-cards-report", userMyCardsReport);
  //---
  app.use(
